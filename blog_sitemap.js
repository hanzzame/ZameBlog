...
// ---------------------------------------------------
// Author: HanzZame
// Url: http://hanzzame.blogspot.com
// Version: 1
// Date: 2016-04-18
// ---------------------------------------------------
         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title="Klik disini untuk semua artikel berdasarkan label \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
